...
class taskInterface(ScrollArea):
    ...
    def __init__(self, sizeHintdb: tuple[int, int], parent=None):
        ...
        self.panelHelp:TransparentToolButton = TransparentToolButton(QIcon(os.path.join(basedir, 'res/icons/question.svg')), self.headerWidget)
    ...
    def __initLayout(self): # 在布局中添加设置卡组
    ...
    def __connectSignalToSlot(self): # 连接信号
    ...
    def _showInstruction(self): # 显示任务说明
...
⏺ To-do Tasks
    ...
    def __showMessageBox(self, title, content, yesText='OK'): # 显示信息框
